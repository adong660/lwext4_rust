...
#[doc = "@brief Master boot record block devices descriptor"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct ext4_mbr_bdevs {
    pub partitions: [ext4_blockdev; 4usize],
}
unsafe extern "C" {
    pub fn ext4_mbr_scan(
        parent: *mut ext4_blockdev,
        bdevs: *mut ext4_mbr_bdevs,
    ) -> ::core::ffi::c_int;
}
#[doc = "@brief Master boot record partitions"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct ext4_mbr_parts {
    #[doc = "@brief Percentage division tab:\n  - {50, 20, 10, 20}\n Sum of all 4 elements must be <= 100"]
    pub division: [u8; 4usize],
}
unsafe extern "C" {
    pub fn ext4_mbr_write(
        parent: *mut ext4_blockdev,
        parts: *mut ext4_mbr_parts,
        disk_id: u32,
    ) -> ::core::ffi::c_int;
}
unsafe extern "C" {
    pub fn test_lwext4_dir_ls(path: *const ::core::ffi::c_char);
}
unsafe extern "C" {
    pub fn test_lwext4_mp_stats();
}
unsafe extern "C" {
    pub fn test_lwext4_block_stats();
}
unsafe extern "C" {
    pub fn test_lwext4_dir_test(len: ::core::ffi::c_int) -> bool;
}
unsafe extern "C" {
    pub fn test_lwext4_file_test(rw_buff: *mut u8, rw_size: u32, rw_count: u32) -> bool;
}
unsafe extern "C" {
    pub fn test_lwext4_cleanup();
}
unsafe extern "C" {
    pub fn test_lwext4_mount(bdev: *mut ext4_blockdev, bcache: *mut ext4_bcache) -> bool;
}
unsafe extern "C" {
    pub fn test_lwext4_umount() -> bool;
}
unsafe extern "C" {
    pub fn tim_wait_ms(v: u32);
}
unsafe extern "C" {
    pub fn tim_get_ms() -> u32;
}
unsafe extern "C" {
    pub fn tim_get_us() -> u64;
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct ext4_io_stats {
    pub io_read: f32,
    pub io_write: f32,
    pub cpu: f32,
}
unsafe extern "C" {
    pub fn io_timings_clear();
}
unsafe extern "C" {
    pub fn io_timings_get(time_sum_ms: u32) -> *const ext4_io_stats;
}
